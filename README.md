# ilTerra WordPress Plugins (Distribution Repository)

This repository serves as the **official distribution hub** for WordPress plugins developed and maintained by [ilTerra.com](https://ilterra.com) (Yauhen Paniamtchanka).
...
2. Download the `.zip` file of the desired plugin and version.
3. In your WordPress admin dashboard, navigate to:
...
© [ilTerra.com](https://ilterra.com) — Maintained by **Yauhen Paniamtchanka**
